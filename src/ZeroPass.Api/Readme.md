...
WORKDIR /src
COPY ["ZeroPass.Core.Api.csproj", "ZeroPass.Core.Api/"]
RUN dotnet restore "ZeroPass.Core.Api/ZeroPass.Core.Api.csproj"

WORKDIR "/src/ZeroPass.Core.Api"
COPY . .
RUN dotnet build "ZeroPass.Core.Api.csproj" --configuration Release --output /app/build

FROM build AS publish
RUN dotnet publish "ZeroPass.Core.Api.csproj" \
...
Execute unit tests
```
    cd "ZeroPass.Core.Api/test/ZeroPass.Core.Api.Tests"
    dotnet test
```
